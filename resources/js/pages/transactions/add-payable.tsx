...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Add Payable',
        href: route('transactions.add-payable'),
    },
];
...
export default function AddPayable() {
        ...
        router.post('/transactions', transactionData, {
            onSuccess: () => {
                showToast({
                    type: 'success',
                    title: 'Payable Added!',
                    message: 'Your payable transaction has been successfully created.',
                    sound: true,
                });
            },
            onError: (errors) => {
                showToast({
                    type: 'error',
                    title: 'Save Failed!',
                    message: 'There was an error saving your payable transaction. Please try again.',
                    sound: true,
                });
            },
        });
    ...
    const handleInputChange = (field: keyof PayableFormData, value: string | number) => {
        setFormData((prev) => ({
            ...prev,
            [field]: value,
        }));
            ...
            <div className="container mx-auto max-w-2xl py-6">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Add Payable</h1>
                            <p className="text-sm text-gray-600">Record a new payable transaction</p>
                        </div>
                    </div>
                ...
                {/* Form Card */}
                <Card className="rounded-xl border-orange-200 bg-orange-50/30 shadow-lg">
                    <CardHeader className="h-fit border-b border-orange-200 bg-orange-100/50">
                        <CardTitle className="flex items-center gap-2 text-orange-800">
                            <CreditCard className="h-5 w-5" />
                            Payable Transaction Details
                        </CardTitle>
                        <CardDescription className="text-orange-700">Enter the details of your payable transaction</CardDescription>
                    </CardHeader>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex flex-col gap-3 border-t border-gray-200 pt-6 sm:flex-row sm:justify-end">
                                ...
                                <Button
                                    type="submit"
                                    size="default"
                                    className="w-full bg-orange-600 px-6 py-2 text-sm font-semibold text-white hover:bg-orange-700 sm:w-auto"
                                >
                                    Add Payable
                                </Button>
                            </div>
