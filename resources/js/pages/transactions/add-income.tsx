...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Add Income',
        href: route('transactions.add-income'),
    },
];
        ...
        router.post('/transactions', transactionData, {
            onSuccess: () => {
                showToast({
                    type: 'success',
                    title: 'Income Added!',
                    message: 'Your income transaction has been successfully created.',
                    sound: true,
                });
            },
            onError: (errors) => {
                showToast({
                    type: 'error',
                    title: 'Save Failed!',
                    message: 'There was an error saving your income transaction. Please try again.',
                    sound: true,
                });
            },
        });
                    ...
                    <CardHeader className="border-b-0 bg-green-50 p-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="text-xl font-bold text-gray-900">Add Income</CardTitle>
                                    <CardDescription className="text-sm text-gray-600">Add a new income transaction</CardDescription>
                                </div>
                            </div>
                            <Button
                                variant="outline"
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        {formData.secondaryCurrency && formData.exchangeRate && (
                                            <p className="mt-1 text-xs text-gray-500">
                                                1 {formData.secondaryCurrency} = {formData.exchangeRate} {primaryCurrency}
                                            </p>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col gap-3 border-t border-gray-200 pt-6 sm:flex-row sm:justify-end">
                                ...
                                <Button
                                    type="submit"
                                    size="default"
                                    className="w-full bg-green-600 px-6 py-2 text-sm font-semibold text-white hover:bg-green-700 sm:w-auto"
                                >
                                    Add Income
                                </Button>
                            </div>
