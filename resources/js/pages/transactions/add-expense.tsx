...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Add Expense',
        href: route('transactions.add-expense'),
    },
];
        ...
        router.post('/transactions', transactionData, {
            onSuccess: () => {
                showToast({
                    type: 'success',
                    title: 'Expense Added!',
                    message: 'Your expense transaction has been successfully created.',
                    sound: true,
                });
            },
            onError: (errors) => {
                showToast({
                    type: 'error',
                    title: 'Save Failed!',
                    message: 'There was an error saving your expense transaction. Please try again.',
                    sound: true,
                });
            },
        });
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex flex-col gap-3 border-t border-gray-200 pt-6 sm:flex-row sm:justify-end">
                                ...
                                <Button
                                    type="submit"
                                    size="default"
                                    className="w-full bg-red-600 px-6 py-2 text-sm font-semibold text-white hover:bg-red-700 sm:w-auto"
                                >
                                    Add Expense
                                </Button>
                            </div>
