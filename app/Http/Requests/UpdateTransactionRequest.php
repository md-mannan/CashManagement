...
class UpdateTransactionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'required|in:income,expense,receivable,payable,settlement,settle_receivable,settle_payable',
    ...
    protected function validateFinancialConstraints(Validator $validator): void
    {
        ...
        // Allow settlement transactions to be updated without financial constraints
        if (in_array($type, ['settlement', 'settle_receivable', 'settle_payable'])) {
            return;
        }
    ...
    public function messages(): array
    {
        return [
            ...
            'type.in' => 'Transaction type must be income, expense, receivable, payable, settlement, settle_receivable, or settle_payable.',
